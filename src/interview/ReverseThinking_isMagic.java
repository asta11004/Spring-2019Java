...
public class ReverseThinking_isMagic {
  ...
  public static void main(String[] args) {
    ...
    //System.out.println(data[0][lastIndex-0] + data[1][lastIndex-1] + data[2][lastIndex-2]    );
...
// /code-open ReverseThinking_isMagic.java 1-171 /I4gYg